	...
	<div class="form">
		...
		<div class="form-wr">
			...
			<form method="post" id="one_click_buy_form" action="<?=$arResult['SCRIPT_PATH']?>/script.php">
				...
				<div class="" style="width: 100%; text-align: center; margin-bottom: 2rem; font-size: 1rem;" >
Нажимая кнопку "Оформить заказ" вы соглашаетесь с условиями договора  <a href="/include/public_offer.php" target="_blanck" style="color: #830D34;">публичной оферты</a>
</div>
