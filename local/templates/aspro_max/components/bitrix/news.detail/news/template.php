...
if(isset($arResult['PROPERTIES']['BNR_TOP']) && $arResult['PROPERTIES']['BNR_TOP']['VALUE_XML_ID'] == 'YES')
{
	...
	if(isset($arResult['PROPERTIES']['BNR_ON_HEADER']) && $arResult['PROPERTIES']['BNR_ON_HEADER']['VALUE_XML_ID'] == 'YES')
	{
...
?>
			<div class="head-block">
				<div class="row flexbox prodj_ban_row " style="">
					<div class="col-sm-12 item info_wrap prodj_ban_col_12" style="">
						<div class="flexbox prodj_ban_fon" style="background-image: url('<?=$arResult['DETAIL_PICTURE']['SRC']?>'); background-position: center, center; background-size: cover;  width: 100%; padding-left: 50px;">
						<div class="info wti" >
							<?if($arResult['DISPLAY_PROPERTIES_FORMATTED'] || ($bShowFormQuestion || $bShowFormOrder)):?>
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-12">
											<div class="buttons-block">
												<div class="wrap">
													...
													<?if($bShowFormQuestion):?>
														<div class="form_btn">
															<span class="btn btn-lg btn-default <?/*=($bShowFormOrder ? 'btn-transparent-border-color' : 'btn-default')*/?> <?/*=($bShowFormOrder ? 'white' : '')*/?>  animate-load" data-event="jqm" data-param-form_id="ASK" data-autoload-need_product="<?=CMax::formatJsName($arResult['NAME']);?>" data-name="question"><span><?=(strlen($arParams['S_ASK_QUESTION']) ? $arParams['S_ASK_QUESTION'] : Loc::getMessage('S_ASK_QUESTION'))?></span></span>
														</div>
													<?endif;?>
												</div>
											</div>
...
-->
<!-- закомментированный слайдер конец -->
...
<?if((strlen($arResult['FIELDS']['DETAIL_TEXT']) || strlen($arResult['FIELDS']['PREVIEW_TEXT']) ||  $arResult['FIELDS']['DETAIL_PICTURE'])
	&& $arParams["STAFF_MODE"] != "Y" && $arParams["SHOW_TOP_PARTNERS_BLOCK"] != "Y"):?>
	<?
		...
		<div class="inner_wrapper_text">
			<div class="content-text <?=($bWideText ? 'wide-text' : '');?> muted777">
				...
				<div class="inline-block">
					<span class="callback-block animate-load font_upper_xs colored" data-event="jqm" data-param-form_id="CALLBACK" data-name="callback" style="font-size:15px;">
						Заказать звонок
					</span>
				</div>
...
<?if($arResult['DISPLAY_PROPERTIES_FORMATTED'] && $arParams["SHOW_TOP_PROJECT_BLOCK"] != "Y" && $arParams["STAFF_MODE"] != "Y" && $arParams["SHOW_TOP_PARTNERS_BLOCK"] != "Y"):?>	
