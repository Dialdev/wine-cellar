...
<div class="main-catalog-wrapper">
	<div class="section-content-wrapper <?=($bShowLeftBlock ? 'with-leftblock' : '');?>">
		...
		<?// section elements?>
		<!-- <? echo('page_blocks/'.$arParams["SECTION_ELEMENTS_TYPE_VIEW"].'.php'); ?> -->
...
// global $USER;
// if ($USER->IsAdmin()) // увидит только админ
//   {
// //    var_dump ($issetCondition);
// 	echo '<pre>';
// 	print_r($arParams["SECTION_ELEMENTS_TYPE_VIEW"]);
// 	echo '</pre>';
...
/* вывод пользовательского поля раздела UF_TEXT_BOT */

$rsResult = CIBlockSection::GetList(array("SORT" => "ASC"), array("IBLOCK_ID" => $arParams["IBLOCK_ID"], "ID" => $arResult['VARIABLES']['SECTION_ID']), false, $arSelect = array("UF_*"));
if($arSection = $rsResult->GetNext()) {  
	$bobot_new = $arSection["~UF_TEXT_BOT"];
	/*echo "<pre>";
print_r($arSection);
echo "</pre>";*/
}
