...
<?if($iSectionsCount):?>
<? file_put_contents(dirname(__FILE__)."/log.txt", print_r($iSectionsCount, true), FILE_APPEND); ?>
	<?$this->SetViewTarget("top_content");?>
		<div class="section-block">

      <?$APPLICATION->IncludeComponent(
				"bitrix:catalog.section.list",
				"sections_compact_custom",
				Array(
...
<?endif;?>
          ...
          <!--Блок дескрипт-->
						<?if ($arSection[$arParams["SECTION_PREVIEW_PROPERTY"]]):?>
							<div class="group_description_block top muted777 amt10">
...
<?
	...
	// Фильтр вывода только акционных товаров в раздел "Акционные товары"
	if ($arResult['VARIABLES']['SECTION_ID'] == 661)
	{
		$GLOBALS[$arParams["FILTER_NAME"]][] = array(
			"PROPERTY_AKTSIYA_NA_SAYTAKH" => 696, // Свойство "Товар со скидкой" в значении "Да"
			">PROPERTY_SPETSIALNAYA_TSENA_PO_AKTSII" => 0, // Свойство "Зачеркнутая цена по акции" не пустое
			"!PROPERTY_UTSENEN_1" => 10912, // Свойство "Качество" не равно "Уценён"
		);
		$APPLICATION->IncludeComponent(
