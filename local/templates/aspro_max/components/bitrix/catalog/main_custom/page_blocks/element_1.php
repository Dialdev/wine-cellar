...
<div class="aa left_block sticky-sidebar-custom product-side main_item_wrapper js-offers-calc <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?>">
