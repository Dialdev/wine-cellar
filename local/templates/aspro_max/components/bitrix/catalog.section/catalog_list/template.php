...
*/
					...
					<div class="information_wrapp main_item_wrapper">
						<div class="information <?=($arItem["OFFERS"] && $arItem['OFFERS_PROP'] ? 'has_offer_prop' : '');?>  inner_content js_offers__<?=$arItem['ID'];?>_<?=$arParams["FILTER_HIT_PROP"]?>">
							...
							<div class="cost prices clearfix <? if ($arItem['PROPERTIES']['AKTSIYA_NA_SAYTAKH']['VALUE'] == 'Да') echo 'price-on-sale';?>">
								<?if($arItem["OFFERS"]):?>
								...
								<?else:?>
									...
									<?elseif($arItem["PRICES"]):?>
										<!-- <? var_dump($arItem['PROPERTIES']['AKTSIYA_NA_SAYTAKH']['VALUE'] == 'Да'); ?> -->
