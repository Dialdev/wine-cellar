...
<?if($arResult["SECTIONS"]){?>
	...
	<div class="section-compact-list_custom">
		<div class="row<?=($bSlick ? ' margin0' : '');?> flexbox">
			...
			?>
				<div class="section-compact-list__item_outer">
					<div class="section-compact-list__item_custom item bordered box-shadow flexbox flexbox--row" id="<?=$this->GetEditAreaId($arItems['ID']);?>">
						...
						<div class="section-compact-list__info">
							...
							<?if($arItems["ELEMENT_CNT"]):?>
								<span class="element-count2 muted font_upper">(<?=$arItems["ELEMENT_CNT"]?>)</span>
							<?endif;?>
						</div>
					</div>
				</div>
...
//$APPLICATION->ShowViewContent('seo.meta.tags');
?>
</div>