$(document).ready(function(){
	var heightFilter = $('#custom-filter-outer-container').height();
	$(window).scroll(function() {
		var elemsTop = $('#custom-filter-outer-container').offset().top,
			winTop = $(window).scrollTop();
		if($('div').is('#custom-filter-outer-container')){
			console.log(elemsTop);
			console.log(winTop);
			if(winTop - elemsTop >= 300 && winTop - elemsTop <=400){
				$('#custom-filter-outer-container').height(heightFilter);
				$('#custom-filter-outer-container').addClass('prefixed');
				$('#custom-filter-outer-container').removeClass('fixed');
			}else if(winTop - elemsTop > 400){
				$('#custom-filter-outer-container').addClass('fixed');
			}else{
				$('#custom-filter-outer-container').height('auto');
				$('#custom-filter-outer-container').removeClass('fixed');
				$('#custom-filter-outer-container').removeClass('prefixed');
			}
