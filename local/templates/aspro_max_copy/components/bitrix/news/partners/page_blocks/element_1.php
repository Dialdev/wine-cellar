...
<?if($arParams["SHOW_LINKED_PRODUCTS"] == "Y" && strlen($arParams["LINKED_PRODUCTS_PROPERTY"])):?>
	...
	$fffff=CIBlockPropertyEnum::GetList([],['VALUE'=>$arElement["NAME"],'PROPERTY_ID'=>427,'IBLOCK_ID'=>11]);
	if($f=$fffff->Fetch())
		$GLOBALS['arrProductsFilter']["PROPERTY_".$arParams["LINKED_PRODUCTS_PROPERTY"]] = $f['ID'];
