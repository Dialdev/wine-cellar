...
$APPLICATION->SetPageProperty("description", "Контакты интернет-магазина WineCellar");
...
<div class="wrapper_inner_half row flexbox shop-detail1 clearfix" itemscope itemtype="http://schema.org/Organization">
	<div class="item item-shop-detail1  <?=($showMap ? 'col-md-5' : 'col-md-12')?>">
			...
			<div class="bottom_block">
				<div class="properties clearfix">
					...
					<div class="col-md-6 col-sm-6">
						...
						<?//CMax::showContactOrgn('ОРГН', false);?>
					</div>
				</div>
				<div class="social-block">
					<div class="wrap contact-soc">
...
<!--Описание Контакты -->
	...
	<?if($showMap):?>
	<div class="item col-md-6 map-full padding0" style="">
